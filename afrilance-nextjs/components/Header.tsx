...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-orange-100">
      <div className="max-w-[1400px] mx-auto px-4 lg:px-6 h-[64px] flex items-center justify-between gap-4">
        {/* Logo */}
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-1">
            <span className="text-[28px] font-extrabold tracking-tight">afri</span>
            <span className="text-[28px] font-extrabold tracking-tight text-[#FF6B35]">lance</span>
            <span className="text-[28px] font-extrabold text-[#FF6B35]">.</span>
          </div>
