...
export default function ManoeuvreDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto max-w-[1100px] px-4 py-6">
        <h1 className="text-[22px] font-bold text-zinc-900 mb-1">Dashboard Manœuvre</h1>
        <p className="text-[13px] text-zinc-500 mb-6">Profil : Manœuvre · 1 garant obligatoire + 2 optionnels</p>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {[{ label: "Qualifications", href: "/declarations", icon: "📜" }, { label: "KYC", href: "/kyc", icon: "🛡️" }, { label: "Garants", href: "/profile", icon: "👥" }].map(a => (
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-zinc-100"><h2 className="font-semibold text-[15px]">Missions disponibles</h2></div>
        ...
        <div className="mt-4 px-4 py-3 rounded-xl bg-[#FEF9C3] border border-[#FCD116] text-[13px] text-zinc-700">
          <strong>Rappel :</strong> votre badge &quot;Identité vérifiée&quot; dépend uniquement de votre KYC. Niveau et expérience sont déclarés par vous.
        </div>
      </div>
    </div>
  );
