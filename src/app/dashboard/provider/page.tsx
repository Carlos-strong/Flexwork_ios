  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto max-w-[1100px] px-4 py-6">
        <h1 className="text-[22px] font-bold text-zinc-900 mb-1">Dashboard Prestataire</h1>
        <p className="text-[13px] text-zinc-500 mb-6">Missions disponibles dans votre domaine</p>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {[{ label: "Mon profil", href: "/profile", icon: "👤" }, { label: "Qualifications", href: "/declarations", icon: "📜" }, { label: "KYC", href: "/kyc", icon: "🛡️" }].map(a => (
