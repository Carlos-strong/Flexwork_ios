...
const USER: DashboardUser = { initials: "AR", name: "Artisan", role: "Artisan", avatarGradient: "from-[#E8112D] to-[#FCD116]" };
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
        <div><h1 className="text-[22px] md:text-[26px] font-bold text-[#0A1931] tracking-tight">Bonjour Artisan 👋</h1><p className="text-[13px] text-zinc-500 mt-1"><span className="text-[#FF7A00]">✦</span> <span className="font-semibold text-[#FF7A00]">3 missions</span> en cours • 1 nouveau client</p></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-[20px] border border-gray-100 overflow-hidden"><div className="px-5 py-4 border-b border-gray-50"><h3 className="font-semibold text-[14px]">Garants</h3></div><div className="px-5 py-4 space-y-2 text-[12px]"><div className="flex items-center gap-2 p-2 rounded-xl bg-red-50"><span className="w-2 h-2 rounded-full bg-red-500" /> Garant principal — <span className="font-semibold text-red-700">Requis</span></div><div className="flex items-center gap-2 p-2 rounded-xl bg-gray-50"><span className="w-2 h-2 rounded-full bg-gray-400" /> Garant 1 — <span className="text-zinc-500">Optionnel</span></div><div className="flex items-center gap-2 p-2 rounded-xl bg-gray-50"><span className="w-2 h-2 rounded-full bg-gray-400" /> Garant 2 — <span className="text-zinc-500">Optionnel</span></div></div></div>
